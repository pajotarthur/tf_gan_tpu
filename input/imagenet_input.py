...
from common import resnet_preprocessing
...
class ImagenetRecordInput(ImageNetTFExampleInput):
    ...
    def __init__(self,
                 ...
                 num_parallel_calls=8,
                 cache=False):
        super(ImagenetRecordInput, self).__init__(
    ...
    def dataset_parser(self, value):
        ...
        return super(ImagenetRecordInput, self).dataset_parser(value)
    ...
    def make_source_dataset(self, index, num_hosts):
        ...
        self.data_files = tf.gfile.Glob(os.path.join(self.data_dir, '*.tfrecords'))
        ...
        dataset = filename_dataset.apply(tf.data.experimental.parallel_interleave(
            tfrecord_dataset,
...
class InputFunction(object):
  ...
  def __init__(self, is_training, noise_dim, num_classes, data_dir="./dataset",
