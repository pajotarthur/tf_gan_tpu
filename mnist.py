...
import input.dataset_mnist as dataset  # pylint: disable=wrong-import-position
import models.mnist_tpu as mnist  # pylint: disable=wrong-import-position
...
tf.flags.DEFINE_integer("train_steps", 15000, "Total number of training steps.")
